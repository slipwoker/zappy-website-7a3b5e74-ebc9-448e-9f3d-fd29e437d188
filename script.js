    ...
    function getOrCreateError(field) {
      ...
      if (!errorEl) {
        ...
        errorEl.style.cssText =
          'color:#e53e3e;font-size:0.85em;display:block;margin-top:4px;';
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        if (firstInvalidField) {
          ...
          const top =
            firstInvalidField.getBoundingClientRect().top +
            window.pageYOffset -
            offset;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טבע הבריאה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7a3b5e74-ebc9-448e-9f3d-fd29e437d188',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7a3b5e74-ebc9-448e-9f3d-fd29e437d188';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7a3b5e74-ebc9-448e-9f3d-fd29e437d188';
